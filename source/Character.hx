...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'gf-night':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('night/GF_assets', 'hex');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'gf-glitcher':
				// GIRLFRIEND CODE
				tex = Paths.getSparrowAtlas('glitcher/GF_assets', 'hex');
				frames = tex;
				animation.addByPrefix('cheer', 'GF Cheer', 24, false);
				animation.addByPrefix('singLEFT', 'GF left note', 24, false);
				animation.addByPrefix('singRIGHT', 'GF Right Note', 24, false);
			...
			case 'hex':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('DADDY_DEAREST', 'hex');
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
			...
			case 'hex-night':
				// DAD ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('night/DADDY_DEAREST', 'hex');
				frames = tex;
				animation.addByPrefix('idle', 'Dad idle dance', 24);
				animation.addByPrefix('singUP', 'Dad Sing Note UP', 24);
				animation.addByPrefix('singRIGHT', 'Dad Sing Note RIGHT', 24);
			...
			case 'hex-glitcher':
				...
				addOffset('idle', 0, -44);
				addOffset("singUP", 85, 71);
				addOffset("singRIGHT", 50, -63);
				addOffset("singLEFT", 170, 20);
				addOffset("singDOWN", 89, -109);
			...
			case 'bf-night':
				var tex = Paths.getSparrowAtlas('night/BOYFRIEND', 'hex');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
			...
			case 'bf-glitcher':
				var tex = Paths.getSparrowAtlas('glitcher/BOYFRIEND', 'hex');
				frames = tex;
				animation.addByPrefix('idle', 'BF idle dance', 24, false);
				animation.addByPrefix('singUP', 'BF NOTE UP0', 24, false);
				animation.addByPrefix('singLEFT', 'BF NOTE LEFT0', 24, false);
